...
- [Макро-библиотека ввода/вывода "st_io"]
(#макро-библиотека-ввода-вывода-st_io)
...
- [Программы](#программы)
  ...
  - [7. Поиск минимума и максимума в матрице](#7-найти-минимальный-и-максимальный-элементы-матрицы-и-выввести-их-значения-номер-строки-и-столбца-в-которых-они-находится)
...
### 7. Найти минимальный и максимальный элементы матрицы и вывести их значения, номер строки и столбца, в которых они находится
